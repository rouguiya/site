...
import playstore from '../assets/image/pay/play.jpg';
import appstore from '../assets/image/pay/app.jpg';
import visa from '../assets/image/pay/pay.png';
    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:00221784736669">Call us at +221 (78) 4736669</a></p> </div>
